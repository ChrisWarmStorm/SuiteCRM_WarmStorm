...
COPY docker/apache/railway-forwarded-https.conf /etc/apache2/conf-available/railway-forwarded-https.conf

RUN a2enconf railway-forwarded-https >/dev/null 2>&1 || true
